...
| EditSummaryHelper                      | MediaWiki concepts            | Helper methods for preparing summary instance for editing entity activity                                                                                                                                    |
| EntityPermissionChecker                | MediaWiki concepts            | Service interface for checking a user's permissions on a given entity.                                                                                                                                       |
...
| SummaryFormatter                                                      | MediaWiki concepts            | Formats Wikibase Summary objects to strings for MediaWiki                                                                                                                                                                                                     |
| EntityPermissionChecker                                               | MediaWiki concepts            | Service interface for checking a user's permissions on a given entity.                                                                                                                                                                                        |
| PermissionManager                                                     | MediaWiki concepts            | A MediaWiki service class for checking permissions                                                                                                                                                                                                            |
...
| SummaryFormatter        | MediaWiki concepts | Formats Wikibase Summary objects to strings for MediaWiki                                                                                                                                                                                                     |
| EntityPermissionChecker | MediaWiki concepts | Service interface for checking a user's permissions on a given entity.                                                                                                                                                                                        |
| EditFilterHookRunner    | MediaWiki concepts | Runs the MediaWiki EditFilter hook                                                                                                                                                                                                                            |
| EntityStore             | Persistence        | Storage interface for Entities                                                                                                                                                                                                                                |
